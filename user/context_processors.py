...
from buku.views import total_data_buku,total_data_buku_tersedia,total_data_buku_tidak
...
def total_semua_data(request):
    ...
    total_buku_tersedia = total_data_buku_tersedia(request)
    total_buku_tidak = total_data_buku_tidak(request)
    ...
    return {
        ...
        'total_buku_tersedia': total_buku_tersedia,
        'total_buku_tidak': total_buku_tidak,
